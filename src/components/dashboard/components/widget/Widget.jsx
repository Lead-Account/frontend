...
function Widget({ type }) {
    ...
    switch (type) {
        ...
        case "balance":
            data = {
                ...
                isMoney: true,
                link: "See details",
                icon: <AccountBalanceWalletOutlinedIcon className="icon" style={{ color: "purple", backgroundColor: "rgba(255, 0, 128, 0.2)" }} />
            };
            break;
        default:
            break;
    ...
    return (
        <div className="widget">
            ...
            <div className="right">
                <div className="percentage positive"><KeyboardArrowUpOutlinedIcon />{diff}%</div>{data.icon}
            </div>
        </div>
    )
}
